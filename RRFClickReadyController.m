...
/////////////////////////////////////////////////////////////
#import "RRFClickReadyController.h"

@implementation RRFClickReadyController
...
- (NSString *)dataDirectory {
    return [[definition valueForKey:RRFClickReadyDataDirectoryKey] stringByStandardizingPath];
}
...
- (void)setup {
    ...
    // LOAD NIB
    ///////////
    if([NSBundle loadNibNamed:RRFClickReadyMainNibNameKey owner:self]) {
 ...
 */
- (NSString *)taskName {
    return [definition valueForKey:RRFClickReadyTaskNameKey];
}
...
// ex: NSString * const RRFClickReadyNameOfPreferenceKey = @"RRFClickReadyNameOfPreference"
NSString * const RRFClickReadyTaskNameKey = @"RRFClickReadyTaskName";
NSString * const RRFClickReadyDataDirectoryKey = @"RRFClickReadyDataDirectory";
...
///////////////////////////////////////////////
NSString * const RRFClickReadyMainNibNameKey = @"RRFClickReadyMainNib";
